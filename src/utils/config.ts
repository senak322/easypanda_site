...
export const roolsLi = [
  ...
  `Нажмите кнопку "Заказ оплачен" и ожидайте получение средств после подтверждения от Администратора`,
];
...
export const payData: IPayData = {
  ...
  alipay: {
    card: "13136022300",
    owner: "C. YURII (CHERNIAIEV YURII, если нужно ввести фамилию полностью)",
  },
  wechat: {
    card: "QR",
